...
codeforcesToOmegaup = {
    ...
    "divide and conquer": ["divide and conquer", "meet-in-the-middle"],
    "dp": [
        "memorization",
        "recursion",
        "dynamic programming",
    ...
    "dsu": ["disjoint sets"],
    "expression parsing": ["unformatted input and output", "lexing and parsing"],
    "fft": ["fourier transformation"],
    "flows": ["max flow"],
    "games": ["game theory"],
    "geometry": ["analytic geometry", "convex hull", "sweep line"],
    "graph matchings": ["bipartite matching", "graph connectivity"],
    "graphs": [
    ...
    "greedy": ["greedy algorithms", "schedules"],
    "hashing": ["hashing"],
    "implementation": [
    ...
    "two pointers": ["sliding window", "two pointers technique"],
}
